...
def create_parser():
    ...
    parser.add_argument('-g', '--game', type=str, choices=['snap', 'poker'], default=None, help='Specify a game, '
                                                                                                'either to start '
                                                                                                'up and play, or to '
                                                                                                'read the game\'s '
                                                                                                'instructions')
    ...
    parser.add_argument('-i', '--instructions', action='store_true', help='Print instructions for a specified game'
                                                                          '( see --game <game>).')
